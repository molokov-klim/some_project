...
@print_test_info("Х-отчет (без гашения)")
@allure.title("Х-отчет (без гашения)")
@allure.feature("Сигма Касса")
@allure.story("Проведение чека прихода оплатой наличными .....")
@allure.id("")
def test_RNDAGB_T76_x_report(sk_without_install_fixture, shift_manager):
    # Инициализация
