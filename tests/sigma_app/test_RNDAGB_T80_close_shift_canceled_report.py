...
@print_test_info("Закрытие смены (отчет с гашением)")
@allure.title("Закрытие смены (отчет с гашением)")
@allure.feature("Сигма Касса")
@allure.story("")
@allure.id("")
def test_RNDAGB_T80_close_shift_canceled_report(sk_without_install_fixture):
    # Инициализация
